...
public static class GetFeedbackDetailByStatusMobile
{
    ...
    public class Handler : IRequestHandler<Query, ApiResult<FeedbackDetailMobileDto>>
    {
        ...
        public async Task<ApiResult<FeedbackDetailMobileDto>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            var query = _context.Feedbacks
                ...
                .Where(f => f.IsActive && f.PublicId == request.PublicId && f.CurrentStatusId == status.Id)
                .AsQueryable();
            ...
            if (feedback == null)
            {
                ...
                {
                    Success = false,
                    Message = "Không tìm thấy phản ánh phù hợp với trạng thái"
                };
            }
            ...
            return new ApiResult<FeedbackDetailMobileDto>
            {
                Success = true,
                Data = feedbackDto,
                Message = "Lấy thông tin phản ánh theo trạng thái thành công"
            };
        }
    }
}

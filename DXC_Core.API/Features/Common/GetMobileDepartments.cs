...
public static class GetMobileDepartments
{
    public class Query : IRequest<PagedResult<DepartmentMobileDto>>
    {
    ...
    public class Handler(CoreDbContext dbContext) : IRequestHandler<Query, PagedResult<DepartmentMobileDto>>
    {
        public async Task<PagedResult<DepartmentMobileDto>> Handle(Query request, CancellationToken cancellationToken)
        {
            var query = dbContext.Departments
                .Include(d => d.Organization)
                .Where(d => d.IsActive && d.Organization.IsActive)
                .AsQueryable();
            ...
            return new PagedResult<DepartmentMobileDto>
            {
                Success = true,
                Data = departments,
                Total = totalCount,

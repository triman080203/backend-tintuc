...
public static class GetOcopProductById
{
    public class Query : IRequest<ApiResult<OcopProductDto>>
    {
        public required Guid PublicId { get; set; }
    }

    public class Handler : IRequestHandler<Query, ApiResult<OcopProductDto>>
    {
        ...
        public async Task<ApiResult<OcopProductDto>> Handle(Query request, CancellationToken cancellationToken)
        {

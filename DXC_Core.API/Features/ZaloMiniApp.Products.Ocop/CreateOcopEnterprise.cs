...
public static class CreateOcopEnterprise
{
    ...
    public class Handler : IRequestHandler<Command, ApiResult<OcopEnterpriseDto>>
    {
        ...
        {
            var enterprise = new OcopEnterprise
            {
                ...
                OcopCertificateNumber = request.OcopCertificateNumber,
                Latitude = request.Latitude,
                Longitude = request.Longitude
            };

            _context.OcopEnterprises.Add(enterprise);
            ...
            return new ApiResult<OcopEnterpriseDto>
            {
                Success = true,
                Data = enterpriseDto,
                Message = "Tạo doanh nghiệp OCOP thành công"
            };
        }
    }
}
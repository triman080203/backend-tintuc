...
const TinTucBanNhapPage = () => {
  ...
  const { data, isLoading } = useTinTucList({
    ...
    CurrentStatusId: 1, // draft — Bản nháp
  })
  ...
  return (
    <>
      <ListPageLayout
        title="Bản nháp"
        description="Danh sách tin bài đang được soạn thảo, chưa gửi duyệt"
        breadcrumbItems={[
          { label: 'Quản lý tin tức', href: '/tin-tuc' },
          { label: 'Bản nháp', current: true },
        ]}
        actionBarContent={
          <>
            <Button
...
export default TinTucBanNhapPage

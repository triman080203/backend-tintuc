...
const TinTucDaXuatBanPage = () => {
  ...
  const { data, isLoading } = useTinTucList({
    ...
    CurrentStatusId: 5, // published — Đã xuất bản
  })
  ...
  return (
    <>
      <ListPageLayout
        title="Đã xuất bản"
        description="Danh sách tin bài đã được xuất bản trên ứng dụng"
        breadcrumbItems={[
          { label: 'Quản lý tin tức', href: '/tin-tuc' },
          { label: 'Đã xuất bản', current: true },
        ]}
        actionBarContent={
          <>
            <Button
...
export default TinTucDaXuatBanPage

        ...
        children: [
          {
            ...
            roles: ['admin', 'phong_vien', 'bien_tap_vien', 'tong_bien_tap', generateRoleCodeFromMenuName('Danh mục tin tức')],
          },
          {
            id: 'quan-ly-tin-bai',
...
const newsMenus: NavItemConfig[] = [
  ...
  },
  {
    ...
    href: '/tin-tuc',
    icon: FileText,
    roles: ['admin', 'tong_bien_tap', 'bien_tap_vien', generateRoleCodeFromMenuName('Quản lý tin bài')],
  },
  {
    id: 'tin-bai-ban-nhap',
    name: 'Bản nháp',
    ...
    icon: PenLine,
    roles: ['admin', 'phong_vien', generateRoleCodeFromMenuName('Quản lý tin bài')],
  },
  {
    ...
    icon: Clock3,
    roles: ['admin', 'phong_vien', 'bien_tap_vien', generateRoleCodeFromMenuName('Quản lý tin bài')],
  },
  {
    id: 'tin-bai-da-duyet',
    name: 'Chờ xuất bản',
    ...
    icon: CheckCircle2,
    roles: ['admin', 'phong_vien', 'bien_tap_vien', 'tong_bien_tap', generateRoleCodeFromMenuName('Quản lý tin bài')],
  },
  {
    ...
    icon: Globe,
    roles: ['admin', 'tong_bien_tap', generateRoleCodeFromMenuName('Quản lý tin bài')],
  },
  {
